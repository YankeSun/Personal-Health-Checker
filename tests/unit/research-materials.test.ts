...
describe("research materials", () => {
  ...
  it("provides copyable evidence templates for phone fieldwork", () => {
    ...
    expect(alphaBatchControl).toContain("Git working tree clean");
    ...
    expect(alphaBatchControl).toContain("decisionReview.recommendation");
    ...
    expect(researchReadme).toContain("Experience build gate");
