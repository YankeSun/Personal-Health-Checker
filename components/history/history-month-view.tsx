    ...
    <div className="space-y-6">
      <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-2">
            <h1 className="text-2xl font-semibold text-slate-900">月度回看</h1>
            <p className="max-w-2xl text-sm leading-6 text-slate-600">
              一个月的记录密度、缺口和补录入口，都收在这里。
            </p>
          </div>
      ...
      <section className="grid gap-4 md:grid-cols-4">
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm font-medium text-slate-500">完整天数</p>
          <p className="mt-3 text-3xl font-semibold text-slate-900">{overview.completeDays}</p>
          <p className="mt-2 text-sm text-slate-600">三项齐了</p>
        </article>
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">还有缺口</p>
        </article>
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">本月留下记录的日子</p>
        </article>
      </section>
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="space-y-2">
          <h2 className="text-xl font-semibold text-slate-900">一月一览</h2>
          <p className="text-sm leading-6 text-slate-600">
            绿色是完整，黄色是缺口。点开任意一天都能补录或修正。
          </p>
        </div>
