...
体验版上传前必须保持 Git working tree 干净：先把本轮代码、文档和测试结果 commit / push，再生成 Day 0 preflight 或 evidence pack。这样真机证据、用户反馈和 `research/alpha/ALPHA_BATCH_CONTROL.md` 里的 Git commit 才能对应到同一个版本。
