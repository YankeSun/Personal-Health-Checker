...
|---|---|---|---|
| Day 0 | 清零体验版 P0 配置 blocker | 跑 `alpha:gate:experience -- --batch Alpha-001`、`alpha:readiness -- --vercel --remote`、`alpha:preflight -- --vercel --remote`、`launch:check:*`、`miniprogram:check:*`，只修检查暴露出的真实问题 | 配 AppID / AppSecret、Vercel env、request 域名、隐私配置、类目 / 备案 / 客服入口 |
