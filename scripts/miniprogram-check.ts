...
check("dashboard page shows weekly focus and weight context", hasAll(dashboardWxml, ["今日记录", "体重趋势", "近期记录"]));
check(
...
check("trends page shows weight trend review flow", hasAll(trendsWxml, ["趋势摘要", "体重趋势", "日常标签", "最近记录"]));
check(
