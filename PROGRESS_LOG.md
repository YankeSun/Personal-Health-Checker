...
- 上传微信体验版 0.1.2：`alpha:gate:experience -- --batch Alpha-001` 已 GREEN，微信开发者工具 CLI 成功上传 85.1KB 体验版包；`ALPHA_BATCH_CONTROL.md` 已记录本批次 API 域名、真实 AppID、上传版本和当前 internal_testing 状态，下一步进入 2 台真机验收。`alpha:invite-gate` 已确认唯一 P0 阻塞是 2 台真实手机证据未填写。
